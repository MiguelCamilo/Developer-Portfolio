export default [
	{
		...
		p3: "I have also participated in a hackathon, where I worked with a team of developers to create a citizens non-emergency reporting app using React Native, React, and Node.js, and integrated API's using Fetch and ArcGIS.",
